  ...
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .inject-flash__inner {
      ...
      align-items: center;
      gap: 10px;
      animation: injectPop 0.5s cubic-bezier(0.22, 1, 0.36, 1) both;
    }
    @keyframes injectPop {
      from {
    ...
    .inject-flash__check {
      ...
      height: 58px;
      border-radius: 50%;
      background: linear-gradient(145deg, rgba(16, 185, 129, 0.35), rgba(34, 211, 238, 0.2));
